...
export const ReportsList = ({ data }: IReportsListProps) => {
  return (
    <div className="">
        ...
        <div key={item.id}>
          <div className="flex flex-col gap-2">
            <div className="space-y-2">
              <p className="text-sm font-medium leading-none">Reporter: {item.from}</p>
              <p className="text-sm font-medium leading-none">Perpetrator: {item.to}</p>
