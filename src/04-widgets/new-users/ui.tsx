...
export const NewUsers = ({ data }: INewUsersProps) => {
  const { theme, setTheme } = useTheme()

  const dataKeys = Object.keys(data)

  const [currentYear, setCurrentYear] = useState<string>(dataKeys[dataKeys.length - 1])
  ...
  return (
    <>
      <Select onValueChange={(value) => setCurrentYear(value)} defaultValue={currentYear}>
